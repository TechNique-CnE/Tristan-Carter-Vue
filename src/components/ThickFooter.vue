...
<template>
  <footer>
    <ul>
      ...
      <li><router-link to="/services" :class="{active: activeBase === '/services'}">services</router-link></li>
      <li><router-link to="/projects" :class="{active: activeBase === '/projects'}">projects</router-link></li>
      <!-- <li><router-link to="/blog">blog</router-link></li> -->
      <li><router-link to="/contact" :class="{active: activeBase === '/contact'}">contact</router-link></li>
      <li><router-link to="/about" :class="{active: activeBase === '/about'}">about</router-link></li>
